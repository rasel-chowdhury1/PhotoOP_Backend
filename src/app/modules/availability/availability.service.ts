...
export const ensureAllDaysExist = (weeklySchedule: TDayAvailability[]) => {
...
// for customers browsing a snapper's profile to check availability before booking
const getSpecificUserAvailability = async (userId: string) => {
